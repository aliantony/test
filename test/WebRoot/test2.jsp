...
<script type="text/javascript">
	...
	function uploadFile(key) {
		document.forms[0].action = 'uploadfile.action?callback=parent.upload&key='
				+ key;
	...
	function upload(len, total) {
		document.getElementById('p_first').style.width = (Math.round(len
				/ total * 100))
				+ '%';

		document.getElementById('dis').innerHTML = len + '/' + total
				+ ' Byte';
		if (len === total) {
